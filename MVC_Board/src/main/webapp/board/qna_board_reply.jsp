		...
		<form action="BoardReplyPro.bo" name="boardForm" method="post">
			...
			<table>
				...
				<tr>
					...
					<td class="td_right">
						<input type="text" name="board_subject" required="required"  value="Re:${dto.board_subject }"/>
					</td>
				</tr>
				<tr>
					<td class="td_left"><label for="board_content">내용</label></td>
					<td class="td_right">
						<textarea id="board_content" name="board_content" cols="40" rows="15" required="required">${dto.board_content }</textarea>
					</td>
				</tr>
			</table>
