...
ArrayList<BoardReplyDTO> list = dao.selectBoardReply(idx);
%>
<!DOCTYPE html>
<html>
<head>
	...
	<section id="articleForm">
		...
		<section id="basicInfoArea">
			<table>
				<tr>
					<th>제목</th>
					<td colspan="6"><%=dto.getSubject()%></td>
				</tr>
				<tr>
					<th width="70">작성자</th>
					<td><%=dto.getName()%></td>
					<th width="70">작성일</th>
					<td width="90"><%=dto.getDate()%></td>
					<th width="70">조회수</th>
					<td width="70"><%=dto.getReadcount()%></td>
				</tr>
			</table>
		</section>
		...
		<section id="commandCell">
			...
			<input type="button" value="수정"
				onclick="location.href='modify.jsp?idx=<%=idx%>'"> <input
				type="button" value="삭제"
				onclick="location.href='delete.jsp?idx=<%=idx%>'"> <input
		...
		<section id="replyArea">
			...
			<section id=replyViewArea>
				...
				<section id="basicInfoArea">
					<table>
						<%for (BoardReplyDTO rep : list) {%>
						<tr>
							<th>작성자</th>
							<td colspan="3"><%=rep.getId()%></td>
						</tr>
						<tr>
							<th width="70">댓글내용</th>
							<td><%=rep.getContent()%></td>
							<th width="70">작성일</th>
							<td width="90"><%=rep.getDate()%></td>
